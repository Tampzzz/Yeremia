...
// FECTH PRODUCTS
$sql = "SELECT * from products WHERE category = 'Student'";
$query = $db->prepare($sql);
$query->execute();
...
<body>
  ...
  <section>
    ...
    <?php include('./inc/carouselStudent.php') ?>

    <div class="container mt-5 my-section">
      <h3 class="py-4">Student</h3>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="card h-100 shadow" style="padding: 20px 0; height: 65vh;">
                ...
                <div class="card-body" style="display: flex; flex-direction:column-reverse;">
                  <a href="student.php?add=<?php echo $result->id; ?>" class="btn btn-info mt-2">Add To Cart</a>
